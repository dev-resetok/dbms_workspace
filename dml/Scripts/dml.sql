...
INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, 'YSM123', 'SDAF46', '양승민', '경기도 성남시', '746aa1357@gmail.com', 
TO_DATE('2001-01-01','YYYY-MM-DD'));

INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, 'KMSSS', 'ASDF44', '김민수', '경기도 안산시', '4KMS7@gmail.com', 
TO_DATE('2000-03-06','YYYY-MM-DD'));

INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, '88D9SI', 'CNDF445D', '이현', '서울특별시', 'LEEH4@gmail.com', 
TO_DATE('2004-10-09','YYYY-MM-DD'));

INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, 'love908d', 'asd3883', '정기철', '강원도 속초시', 'KICHEOL17@gmail.com', 
TO_DATE('1998-07-23','YYYY-MM-DD'));

INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, '77sdf23', '1379dfsf5', '박철', '경상북도 경주시', 'IRONPARK@gmail.com', 
...
INSERT INTO TBL_LIKE
VALUES(SEQ_LIKE.NEXTVAL, 1, 5);

INSERT INTO TBL_LIKE
VALUES(SEQ_LIKE.NEXTVAL, 2, 4);

INSERT INTO TBL_LIKE
VALUES(SEQ_LIKE.NEXTVAL, 5, 2);

INSERT INTO TBL_LIKE
VALUES(SEQ_LIKE.NEXTVAL, 3, 2);

INSERT INTO TBL_LIKE
VALUES(SEQ_LIKE.NEXTVAL, 4, 5);

INSERT INTO TBL_LIKE
VALUES(SEQ_LIKE.NEXTVAL, 3, 1);

SELECT ID, LIKE_RECEIVER, LIKE_SENDER FROM TBL_LIKE;

/*3. 회원 별 좋아요 수 조회하기*/

SELECT L.LIKE_RECEIVER, COUNT(L.ID)
FROM TBL_LIKE L
GROUP BY L.LIKE_RECEIVER;

/*4. 회원 별 좋아요 수가 3보다 작은 것만 조회하기*/

SELECT L.LIKE_RECEIVER, COUNT(L.LIKE_SENDER)
FROM TBL_LIKE L 
GROUP BY L.LIKE_RECEIVER
...
INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, 'CDKSD', '2V4GH', '이주영', '경기도 안산시', 'DXCKCD@gmail.com', 
TO_DATE('1989-07-20','YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, 'ZXCVD', 'DDDDD33', '정지원', '서울특별시', '77EE4@gmail.com', 
TO_DATE('1988-11-11','YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
VALUES(SEQ_MEMBER.NEXTVAL, 'QWERT', 'POLKI456', '길호종', '경기도 성남시', 'BBYYII@gmail.com', 
TO_DATE('1985-04-02','YYYY-MM-DD'));

SELECT MEMBER_ADDRESS, AVG(AGE)
FROM
(	
...
INSERT INTO TBL_USER
VALUES(SEQ_USER.NEXTVAL, 'YSM123', '778D5', '경기도 성남시', '746AA1357@gmail.com', '2001-11-19');
...
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 2, 4);

INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 1, 6);

INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 3, 7);

INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 2, 7);

INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 3, 5);

INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 3, 8);

SELECT * FROM TBL_REPLY;

/*댓글 작성자 중 게시글을 등록한 회원 조회*/
SELECT D.USER_ID, P.ID
FROM (
	SELECT R.USER_ID
	FROM TBL_REPLY R
	GROUP BY R.USER_ID
...
(
	...
	FROM
	(
		SELECT LIKE_RECEIVER, COUNT(LIKE_SENDER) AS C
		FROM TBL_LIKE
		GROUP BY LIKE_RECEIVER
		ORDER BY LIKE_RECEIVER ASC
	)
	WHERE C =
	(
		SELECT MAX(COUNT(LIKE_SENDER))
...
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '또치', 5, 1, 5);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '둘리', 7, 2, 5);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '도너', 4, 1, 6);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '마이콜', 4, 2, 7);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '짱구', 5, 2, 8);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '짱아', 5, 1, 8);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
...
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 9);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 10);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 7, 12);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 8, 13);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 6, 14);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 15);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 6, 16);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 6, 15);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 8, 12);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 8, 10);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 12);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 7, 9);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 14);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 16);
...
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '어서와 매미농장', '매미 잡자 어서와', 6);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '아이스크림 빨리 먹기 대회', '아이스크림 누가 더 잘먹나', 7);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '고구마 심기', '고구마가 왕 커요', 9);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '숭어 얼음 낚시', '숭어 잡자 추워도 참아', 8);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '커피 체험 공장', '커비 빈 객체화', 8);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '치즈 제작하기', '여기 치즈 저기 치즈 전부 다 치즈', 8);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '동물 타보기', '이리야!', 9);

SELECT * FROM TBL_FIELD_TRIP;

/*체험학습을 2개 이상 신청한 부모의 아이 정보 조회(단, 부모의 정보는 모두 나와야한다)*/

SELECT P.*, C.ID, C.CHILD_NAME
FROM TBL_CHILD C RIGHT OUTER JOIN TBL_PARENT P
