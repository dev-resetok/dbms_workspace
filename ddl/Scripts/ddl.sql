...
CREATE TABLE TBL_MEMBER(
   ...
   MEMBER_ID VARCHAR22(255) CONSTRAINT UK_MEMBER UNIQUE,
   MEMBER_PASSWORD VARCHAR22(255),
...
CREATE TABLE TBL_ZOO(
   ...
   ZOO_NAME VARCHAR22(255),
   ZOO_ADDRESS VARCHAR22(255),
   ZOO_ADDRESS_DETAIL VARCHAR22(255),
...
CREATE TABLE TBL_ANIMAL(
   ...
   ANIMAL_NAME VARCHAR22(255),
   ANIMAL_TYPE VARCHAR22(255),
...
CREATE TABLE TBL_MEMBER(
   ID NUMBER CONSTRAINT PK_MEMBER PRIMARY KEY,
   MEMBER_ID VARCHAR22(255) CONSTRAINT UK_MEMBER UNIQUE NOT NULL,
   MEMBER_PASSWORD VARCHAR22(255) NOT NULL,
   MEMBER_NAME VARCHAR22(255) NOT NULL,
   MEMBER_ADDRESS VARCHAR22(255) NOT NULL,
   MEMBER_EMAIL VARCHAR22(255),
   MEMBER_BIRTH DATE
);

CREATE TABLE TBL_PRODUCT(
   ID NUMBER CONSTRAINT PK_PRODUCT PRIMARY KEY,
   PRODUCT_NAME VARCHAR22(255) NOT NULL,
...
CREATE TABLE TBL_FLOWER(
   ...
   NAME VARCHAR22(255) NOT NULL CONSTRAINT UK_FLOWER UNIQUE,
   COLOR VARCHAR22(255) NOT NULL,
...
CREATE TABLE TBL_FLOWER_POT(
   ...
   COLOR VARCHAR22(255) NOT NULL,
   SHAPE VARCHAR22(255) NOT NULL,
   FLOWER_NAME VARCHAR22(255) NOT NULL,
   FLOWER_COLOR VARCHAR22(255) NOT NULL,
...
CREATE TABLE TBL_OWNER(
   ...
   NAME VARCHAR22(255) NOT NULL,
   AGE NUMBER,
   PHONE VARCHAR22(255) NOT NULL
);

ALTER TABLE TBL_OWNER ADD(ADDRESS VARCHAR22(255));
...
CREATE TABLE TBL_PET(
   ...
   PET_ILL_NAME VARCHAR22(255),
   PET_NAME VARCHAR22(255),
   PET_AGE NUMBER,
   WEIGHT NUMBER(4, 2),
   OWNER_ID NUMBER,
...
CREATE TABLE TBL_PROFILE(
   ...
   PROFILE_PATH VARCHAR22(255) NOT NULL,
...
CREATE TABLE TBL_STUDENT(
   ...
   STUDENT_NAME VARCHAR22(255) NOT NULL,
   STUDENT_MAJOR VARCHAR22(255) NOT NULL,
   STUDENT_GRADE NUMBER DEFAULT 1
);

CREATE TABLE TBL_PROFESSOR(
   ID NUMBER CONSTRAINT PK_PROFESSOR PRIMARY KEY,
   PROFESSOR_NAME VARCHAR22(255) NOT NULL,
   PROFESSOR_MAJOR VARCHAR22(255) NOT NULL,
   PROFESSOR_POSITION VARCHAR22(255)
);

CREATE TABLE TBL_SUBJECT(
   ID NUMBER CONSTRAINT PK_SUBJECT PRIMARY KEY,
   SUBJECT_NAME VARCHAR22(255) NOT NULL CONSTRAINT UK_SUBJECT UNIQUE,
